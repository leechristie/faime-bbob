...
def loadBBOB2009(force=False):
    ...
    print("Loading best algorithm data from BBOB-2009...", end=' ')
    sys.stdout.flush()
...
def loadBBOB2010():
    ...
    print("Loading best algorithm data from BBOB-2010...", end=' ')  
    bestalgfilepath = os.path.split(__file__)[0]
...
def loadBBOB2012():
    ...
    print("Loading best algorithm data from BBOB-2012...", end=' ')  
    bestalgfilepath = os.path.split(__file__)[0]
...
def loadBBOBever():
    ...
    print("Loading best algorithm data from BBOB...", end=' ')  
    bestalgfilepath = os.path.split(__file__)[0]
